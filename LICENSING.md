...
A `LICENSE-pageindex` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex), Copyright
2025 Vectify AI, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../pageindex-port/specs/SPEC-001-pageindex.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
